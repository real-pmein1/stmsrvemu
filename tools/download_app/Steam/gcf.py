...
class GCF :
    def __init__(self, filename) :
        ...
        if self.header_dummy1 != 1 or self.header_dummy2 != 1 or self.gcfversion != 6 :
            print "Invalid version numbers:", self.header_dummy1, self.header_dummy2, self.gcfversion
            sys.exit()
    ...
    def get_file(self, dirid) :
        ...
        #print "extracting", self.manifest.dir_entries[dirid].fullfilename, self.manifest.dir_entries[dirid].itemsize
