...
print("Steam 2004-2011 HL Master Server Emulator v" + globalvars.emuversion)
print("=====================================")
print
print("**************************")
...
masterhl(globalvars.serverip, config["hlmaster_server_port"]).start()
...
log.info("Steam HL Master Server is ready.")
