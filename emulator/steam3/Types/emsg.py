...
class EMsgFamilyType(SteamIntEnum):
    Unencrypted = 0
    Encrypted = 4


class EMsgType(SteamIntEnum):
    # Old CM Server Packet ID's for handshake
    ChallengeRequest = 1
    ChallengeResponse = 2
    ConnectionRequest = 3
    ConnnectionAccepted = 4
    Disconnection = 5
    CMPacket = 6
    Datagram = 7 # Heartbeat
    EMsgTypeMax = 8
...
class EMsg(SteamIntEnum):
    ...
    def _missing_(cls, value):
        # Dynamically generate a member for any unknown EMsg value
        new_member = int.__new__(cls, value)
        new_member._name_ = f"Unknown_{value}"
        new_member._value_ = value
        # Register it so next time EMsg(value) returns this same member
    ...
    DSReadResponse = 103
    #104
    DSSearchResponse = 105
    DSInsertResponse = 106
    DSUpdateResponse = 107
    DSDeleteResponse = 108
    StatsDescription = 109
    StatsData = 110
    StatsRecord = 111
    StatsRecordDescription = 112
    DestJobFailed = 113
    AlertsRequest = 114
    Alert = 115
    DSVerbResponse = 116
    RequestState = 117
    SendState = 118
    DSQueryResponseOld = 119
    SCIDRequest = 120
    SCIDResponse = 121
    JobHeartbeat = 123
    HubConnect = 124
    Stats_deprecated = 125
    Subscribe = 126
    RouteMessage = 127
    ...
    ZipRequest = 204
    ZipResponse = 205
    GetUserInfoRequest = 206
    GetUserInfoResponse = 207
    BanUserRequest = 208
    BanUserResponse = 209
    RemoveUserBanRequest = 210
    RemoveUserBanResponse = 211
    SetBlobMode = 122
    GetUserInfractionsRequest = 212
    GetUserInfractionsResponse = 213
    UpdateLicenseRequest = 214
    UpdateRecordResponse = 215
    SelectQueryRequest = 216
    SelectQueryResponse = 217
    GetRecordRequest = 218
    GetRecordResponse = 219
    UpdateAccountRequest = 220
    UpdateCreditCardRequest = 221
    AddSupportNote = 222
    UpdateSupportTicket = 223
    #224
    ...
    DSHasReset = 310
    ResetBlobSystem = 311
    RestartBlobSystem = 312
    RequestBlob = 313
    NotifyWatchdog_deprecated = 314
    BlobModeHeartbeat = 315
...
#   AISUpdatePackageInfo = 404 #: removed
    ...
    AISGetMarketingMessageResponse = 412 #: removed aka DSBlob 2005
    AISUpdateMarketingMessage = 413 #: removed aka DSVerb 2005
    ...
    NewChallenge = 501
    AccountUpdate = 502
    AccountUpdateCommit = 503
    AMUpdateUserBanRequest = 504
    AMAddLicense = 505 # aka EMsgAMReloadUserAccount 2005
    UpdateContentDescription = 506
    ...
    ClientAddFriend_deprecated = 713
    ClientRemoveFriend = 714
    ClientRequestFriendData_deprecated = 715
    ...
    ClientUpdateCardInfo = 723
    ClientDeleteCard = 724
    ClientGetCardList = 725
    ClientSystemIM = 726
    ...
    ClientAddFriendResponse_deprecated = 769
    ClientVacStatusQuery = 770 #: removed
    ClientNewsUpdate = 771
    ClientGameConnectToken = 772
    ClientGameConnectDeny = 773
    GSStatusReply = 774
    ClientGetFinalPriceResponse = 775 #: removed
    ClientUpdateCardInfoResponse = 776
    ClientDeleteCardResponse = 777
    ClientGetCardListResponse = 778
    ...
    ClientPreviousClickAndBuyAccount = 806
    ClientChatEnter = 807
    ...
    ClientP2PTrackerData = 813 # from 2008
    ...
    ClientClanState = 822
    #823-829
    ClientServiceModule = 830 #vac3 module
    ...
    ClientVac3SystemInfoReq = 835
    ClientVac3SystemInfoResp = 836
    ClientGetVIPStatus = 837
    ClientVIPStatusResponse = 838
    ...
    ClientAppInfoRequest = 864
    ClientAppInfoResponse = 865
