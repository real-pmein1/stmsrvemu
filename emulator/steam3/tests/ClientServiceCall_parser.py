...
# Example byte string
byte_string = b"?\x03\x00\x00$\x02\x00\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xefmw\xea\x02\x01\x00\x10\x01\x1a\xcf\xaa\x00o\x1c\x12\x00'\xca&\x90\x01\x00\x00\x00\x00\x80\x00\x00\x01"

# Parse the byte string
message = MsgClientServiceCall.from_bytes(byte_string[36:])
print(message)