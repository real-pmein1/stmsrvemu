...
# Assuming the enums EType, EUniverse, and EInstanceFlag are correctly defined in steam_types
...
# Get the 64-bit SteamID
steamid_64 = steamID.get_integer_format()

# Extract the high 4 bytes (contain instance, type, and universe)
high_bytes = steamid_64 >> 32
print(f"High bytes (integer): {high_bytes}")
...
steamID = SteamID(76561197960265730)
print(steamID)"""