...
packet = b'\x05\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x02\x00\x00\x00\x03\x00\x00\x00\x04\x00\x00\x00'

# Deserialize the byte buffer back to an object
deserialized_msg = MsgClientRequestedClientStats.deserialize(packet)
