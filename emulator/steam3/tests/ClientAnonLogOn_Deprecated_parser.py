...
class ClientAnonLogOn_Deprecated:
    ...
    def reverse_ip_int(ip_int):
        ...
        return reversed_ip
# Example usage:
packet = b'\xbe\x02\x00\x00\x00\x00\x00\x00\x00\x00@\x01\x00\x00\x00\x00\x0b\x00\x01\x00\x04\xf0\xad\xb0\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
packet = packet[16:]
parser = ClientAnonLogOn_Deprecated()
parsed_message = parser.deSerialize(packet)

print(f"Protocol Version: {parsed_message.protocolVersion}")
print(f"Private IP: {parsed_message.privateIp}")
print(f"Public IP: {parsed_message.publicIp}")
print(f"Steam Global ID: {parsed_message.steamGlobalId}")
print(f"Unknown1: {parsed_message.unknown1}")
print(f"Unknown2: {parsed_message.unknown2}")
print(f"Unknown3: {parsed_message.unknown3}")
print(f"Unknown4: {parsed_message.unknown4}")
if parsed_message.clientAppVersion:
    print(f"Client App Version: {parsed_message.clientAppVersion}")