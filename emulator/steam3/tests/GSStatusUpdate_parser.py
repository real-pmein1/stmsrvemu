...
# Example usage
byte_data = b"\x8b\x03\x00\x00\x02\x10\xe5t\x1d\x00@\x01\t\x012\x02\x01\x00\x00\x00\x18\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00Foobar's Test server\x00cs_militia\x00"

parser = MsgGSStatusUpdate()
