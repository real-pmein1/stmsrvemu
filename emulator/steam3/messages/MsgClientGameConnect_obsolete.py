...
class MsgClientGameConnect_obsolete:
    """
    Message sent by the client when connecting to a game server.
    EMsg: 719 (ClientGameConnect_obsolete)
    ...
    def __str__(self):
        ...
        return (
            f"MsgClientGameConnect_obsolete(\n"
