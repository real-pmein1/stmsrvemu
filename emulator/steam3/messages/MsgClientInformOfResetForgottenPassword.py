...
class MsgClientInformOfResetForgottenPassword:
    """
    MsgClientResetForgottenPassword_t
    EMsg: ClientInformOfResetForgottenPassword

    Same fixed body layout as above.
    """
    ...
    def to_clientmsg(self) -> CMResponse:
        packet = CMResponse(eMsgID=EMsg.ClientInformOfResetForgottenPassword, client_obj=self.client_obj)
    ...
    def __str__(self):
        return str({
            "emsg": int(EMsg.ClientInformOfResetForgottenPassword),
