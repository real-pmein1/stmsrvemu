...
class masterrdkf(threading.Thread):
    ...
    def run(self):
        ...
        while True :
            ...
            if self.port == 27011 :
                ...
                if globalvars.data.startswith("1") : #31 QUERY
                    ...
                    reply = ""
                    for gameserver in globalvars.rdkfserverlist:
                    ...
                    while i < 1000 :
                        if not isinstance(globalvars.rdkfserverlist[i], int) :
                            ...
                            if ipactual in globalvars.rdkfserverlist[i][0] and portactual in str(globalvars.rdkfserverlist[i][len(globalvars.rdkfserverlist[i]) - 1]) :
        ...
        log.info(clientid + "Disconnected from RDKF Master Server")