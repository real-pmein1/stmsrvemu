...
dirs_to_create = [
    ...
    pjoin("files", "cache", "steam3content"),
    pjoin("files", "cache", "steamworks_data"),
    pjoin("files", "steam3content"),
    pjoin("files", "steam3content", "depots"),
    pjoin("files", "steam3content", "keys"),
    pjoin("files", "steam3content", "manifest_list"),
