...
# This module will hold global variables accessible across different server threads
server_threads = {}
...
known_blobs = {}
known_dats = {}
ini_changed_by_server = False
current_blob_datetime = None
...
##########################################
neuter_path = "py39_tools/neuter/download_app.py" if platform.system() == 'Linux' or config['from_source'].lower() == "true" else "files/tools/neuter.exe" if platform.system() == 'Windows' else "Unknown OS, unknown path. Good luck figuring that out."


# TODO the following may not be entirely nessecary
