...
class NCF(object):
    def __init__(self, filename):
        ...
        self.firstblockoffset = None
        self.frag_entries = None
        ...
        print(f"Header data - appid: {self.appid:d} appver: {self.appversion:d} blockcount: {self.blockcount:d} dummy5: {self.header_dummy5:d}")
        ...
        # block_data = io.BytesIO(self.f.read(self.blockcount * 28))
        # self.block_entries = {}
        ...
        # frag_data = io.BytesIO(self.f.read(blockcount * 4))
        # self.frag_entries = {}
        ...
        dirmap_data = io.BytesIO(self.f.read(self.manifest.num_items * 4))
        self.dirmap_entries = {}
