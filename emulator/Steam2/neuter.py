...
filenames = ("SteamNew.exe", "Steam.dll", "SteamUI.dll", "Public\Account.html", "caserver.exe", "cacdll.dll", "CASClient.exe", "unicows.dll")#, "steamclient.dll", "GameOverlayUI.exe", "serverbrowser.dll", "gamoverlayui.dll", "steamclient64.dll", "AppOverlay.dll", "AppOverlay64.dll", "SteamService.exe", "friendsUI.dll", "SteamService.dll")
...
("http://www.steampowered.com/platform/banner/random.php",
 "http://" + config["http_ip"] + config["http_port"] + config["banner_url"],
 "Banner URL"),
("/index.php?l=%s&s=%s&i=%s&vac=%d&ver=%d&client=1",
 config["online_webpage"],
 "Online webpage"),
("http://storefront.steampowered.com/platform/update_history/index.php",
 "http://" + config["http_ip"] + config["http_port"] + "/platform/update_history/index.php",
 "Client news URL"),
("/index.php?area=game&AppId=%i&gId=%i%s&l=%s&s=%s&i=%s&vac=%d&ver=%d&client=1",
 config["appnews_url"],
 "App news URL"),
...
("http://storefront.steampowered.com",
 "http://" + config["http_ip"] + config["http_port"] + config["store_url"],
 "Storefront URL"),
("http://support.steampowered.com",
 "http://" + config["http_ip"] + config["http_port"] + config["support_url"],
 "Support URL"),
...
("http://www.steampowered.com/platform/banner/",
 "http://" + config["http_ip"] + config["http_port"] + config["banner_url2"],
 "New banner URL 1"),
